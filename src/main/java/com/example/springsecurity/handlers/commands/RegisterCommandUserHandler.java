...
//
//        if (strRoles == null) {
//            String userRole = queryRoleMapper.findByRoleName(USER);
//            roles.add(userRole);
//        } else {
//            strRoles.forEach(role -> {
//                switch (role) {
//                    case "ADMIN": String admin = queryRoleMapper.findByRoleName(ADMIN);
//                        roles.add(admin);
//                        break;
//                    case "MANAGER": String manager = queryRoleMapper.findByRoleName(MANAGER);
//                        roles.add(manager);
//                        break;
//                    case "USER": String user = queryRoleMapper.findByRoleName(USER);
//                        roles.add(user);
//                        break;
//                    default:
